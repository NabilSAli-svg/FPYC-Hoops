import { Card, Pill, Button, Icon, Display } from '../shared/index.js';
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '120px 1fr auto auto', gap: 18, alignItems: 'center', padding: '16px 20px' }}>
              ...
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
                  {isLive
                    ? <Pill kind="live" pulse>Live · Q3 4:21</Pill>
                    : isFinal
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                {isLive
                  ? <Button kind="primary" icon="play">Watch</Button>
                  : isFinal
                    ? <Button kind="ghost" size="sm" icon="file-text">Box score</Button>
                    : <>
