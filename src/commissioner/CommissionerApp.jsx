...
function DraftTab() {
  return (
    <div style={{ padding: '32px', textAlign: 'center', color: 'var(--fg-muted)' }}>
      ...
      <div style={{ fontSize: 16, fontWeight: 700, marginBottom: 8 }}>Draft Board has moved</div>
      <div style={{ fontSize: 13 }}>Use the <strong>Draft Board</strong> section in the Admin Console to manage drafts.</div>
    </div>
  );
}
// ─── Main App ─────────────────────────────────────────────────────────────────
