...
window.Hero = function Hero({ onRegister }) {
  return (
    <section id="hero" style={{
      ...
      {/* Soft varsity glow + court lines background */}
      <div style={{
      ...
      <div style={{ position: 'absolute', right: -120, bottom: -60, opacity: 0.06, pointerEvents: 'none' }}>
        <img src="../../assets/court-half.svg" alt="" style={{ width: 800, color: '#fff' }}/>
      </div>
      ...
      <div style={{
        ...
        <div>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'rgba(255,199,44,0.14)', color: 'var(--varsity-gold)', padding: '6px 12px', borderRadius: 999, fontFamily: 'var(--font-body)', fontWeight: 700, fontSize: 12, letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: 20 }}>
            <span style={{ width: 6, height: 6, background: 'var(--varsity-gold)', borderRadius: '50%' }}/>
            2025–26 Season · Now open
          </div>
          <div style={{ fontFamily: 'var(--font-display)', textTransform: 'uppercase', letterSpacing: '0.01em', fontSize: 'clamp(40px, 5.5vw, 72px)', lineHeight: 1, marginBottom: 18 }}>
            Get in the game.<br/>
            <span style={{ color: 'var(--varsity-gold)' }}>Register today.</span>
          </div>
          <p style={{ fontSize: 18, lineHeight: 1.55, color: 'rgba(255,255,255,0.82)', maxWidth: 560, marginBottom: 28, textWrap: 'pretty' }}>
          ...
          <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', marginBottom: 28 }}>
            ...
            }}>Register for 2025–26 <WIcon name="arrow-right" size={16}/></a>
            <a href="#programs" style={{
              ...
              display: 'inline-flex', alignItems: 'center', gap: 8,
            }}><WIcon name="play-circle" size={16}/> See programs</a>
          </div>
        ...
        {/* Right: registration deadline card */}
        <div style={{ background: '#fff', color: 'var(--fg)', borderRadius: 14, padding: 28, boxShadow: '0 24px 60px rgba(0,0,0,0.30)', position: 'relative' }}>
          ...
          <div style={{ background: 'var(--bone)', border: '1px solid var(--border)', borderRadius: 8, padding: 14, marginBottom: 14 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
              <WIcon name="alert-triangle" size={14} color="var(--status-warning)"/>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8, fontSize: 13 }}>
            <Line icon="check" text="Scholarships available — apply during registration" />
            <Line icon="check" text="Sibling discount: 10% off second child" />
            <Line icon="check" text="Volunteer credit reduces next-season fee" />
          </div>
        </div>
      </div>
    </section>
...
function Line({ icon, text }) {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
      <WIcon name={icon} size={14} color="var(--status-win)"/>
